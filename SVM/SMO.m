function [ bias, alpha ] = SMO(t, C, tau, X )
...
while 1  
    ...
    %to check whether the SMO works or no, we can check if the b_up-b_low in equation (3) in the SVM documentation keeps decreasing
